...
func NewGrpcUserHandler(userService service.UserService) *UserHandler {
	return &UserHandler{
		userService: userService,
	}
}

func (grpcHandler *UserHandler) CreateUser(ctx context.Context, req *pb.CreateUserRequest) (*pb.CreateUserResponse, error) {
...
func (grpcHandler *UserHandler) Login(ctx context.Context, req *pb.LoginRequest) (*pb.LoginResponse, error) {
...
func (grpcHandler *UserHandler) GetUserByID(ctx context.Context, req *pb.IDRequest) (*pb.UserResponse, error) {
	logging.LogMessage("user_service", "Fetching user by ID", "INFO")
	logging.LogMessage("user_service", "userID: "+req.Id, "DEBUG")

	user, err := grpcHandler.userService.GetUserByID(ctx, req.Id)
	if err != nil {
...
func (grpcHandler *UserHandler) GetAllUsers(ctx context.Context, req *pb.EmptyRequest) (*pb.UsersResponse, error) {
	logging.LogMessage("user_service", "Fetching all users", "INFO")

	users, err := grpcHandler.userService.GetAllUsers(ctx)
	if err != nil {
